...
export default function TenantsShow({ tenant }: Props) {
    ...
    const handleDelete = (e: React.FormEvent) => {
        ...
        if (
            confirm(
                `Are you absolutely sure you want to delete ${tenant.name}? This will DROP their entire database and cannot be undone.`,
            )
        ) {
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:p-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <Button asChild>
                            <Link
                                href={centralTenantsEdit({ tenant: tenant.id })}
                            >
                                Edit
                            </Link>
                        </Button>
                    ...
                    <div className="rounded-md border bg-card p-6 shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 mb-2 text-sm text-muted-foreground">
                                    Once you delete an LGU, their database and
                                    all HR records are permanently removed. This
