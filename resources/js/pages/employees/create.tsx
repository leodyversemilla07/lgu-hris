...
export default function CreateEmployee({
    ...
    const summaryCards = [
        ...
        },
        {
            ...
            value: '8',
            detail: 'Core identity and employment values must be completed.',
            icon: ShieldCheck,
        },
        {
            title: 'Registry outcome',
            value: form.data.is_active ? 'Active' : 'Archived',
            detail: 'New records stay active unless you intentionally archive them.',
                            ...
                            <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                                <div className="flex max-w-3xl flex-col gap-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Capture a complete employee profile
                                        before it enters the registry. The form
                                        follows the same neutral workspace style
                                        used across the rest of the HRIS.
                                    </p>
                                </div>
                        ...
                        <div className="grid gap-6 px-4 lg:px-6 xl:grid-cols-[minmax(0,1fr)_320px]">
                            <div className="flex flex-col gap-6">
                                <FormSection
                                    ...
                                    description="Identity, civil profile, and direct contact details used across records and reports."
                                >
                                ...
                                <FormSection
                                    title="Address"
                                    description="Primary residence and locality details used for employee contact records."
                                >
                            ...
                            <div className="flex flex-col gap-6">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Control whether this employee enters
                                            the registry as active or archived.
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="flex flex-col gap-4">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            ...
                                            Switch this only when encoding an
                                            archived or inactive profile.
                                        </p>
                                    </CardContent>
                                    <CardFooter>
                                        <Button
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            ...
                                            employment fields so the record can
                                    ...
                                    <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground">
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <span>
                                                ...
                                                for proper downstream reporting.
                                            </span>
                                        </div>
                                    </CardContent>
