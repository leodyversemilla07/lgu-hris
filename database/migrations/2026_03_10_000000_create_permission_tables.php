...
return new class extends Migration
{
    public function up(): void
    {
        ...
        throw_if(empty($tableNames), 'Error: permission config not loaded.');
        throw_if($teams && empty($columnNames['team_foreign_key'] ?? null), 'Error: permission team configuration not loaded.');
